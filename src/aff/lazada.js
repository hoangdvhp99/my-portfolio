export default function lazadaCheck() {
  let utm_source = '';
  let utm_content = '';
  let utm_medium = '';
  let utm_campaign = '';
  ...
  let atProductGenerateHtml = `<div class="at--card">
				...
				<img class="at--w100 at--radius" src="https://content.accesstrade.vn/adv/1717486626_avatar_1717486626.gif"/>
				</div>
				</div>
  ...
  let atProductGenerateElement = document.getElementById('at-widget-lazada');
  ...
  async function setText(text) {
    ...
    if (response?.status_code == 1 && response?.success_link)
      text = response?.success_link;
    return text;
  }

  let URLObj = new URL('https://www.lazada.vn/');
  ...
  convertLinkBtn.addEventListener('click', function (event) {
    ...
    if (event.target && event.target.id === 'at--convert-link-btn') {
      console.log(
        'params---------> ',
        '{"campaign_name":"LAZADA (CPS)","campaign_logo":"https://content.accesstrade.vn/adv/1717486626_avatar_1717486626.gif","max_commission":"Hoa hồng ngon","btn_text":"Mua Ngay","btn_color":"#1570EF","publisher_id":"5814550641003739915","campaign_id":"5127144557053758578","utm_source":"","utm_content":"","utm_medium":"","utm_campaign":"","original_link":"https://www.lazada.vn/"}',
      );
      navigator.clipboard
        .readText()
        .then(async text => {
          ...
          let deepLink = `https://go.isclix.com/deep_link/5814550641003739915/5127144557053758578?sub3=tooldirectlink&sub4=oneatweb`;
